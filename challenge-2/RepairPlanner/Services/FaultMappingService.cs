...
/// In production, this would fetch from a database or external system.
/// </summary>
public sealed class FaultMappingService : IFaultMappingService
{
    // Fault type → required technician skills
    ...
    // Fault type → required part numbers
    ...
    {
        // TryGetValue returns the value if found, otherwise we return default
    ...
    /// <summary>
    /// Gets the required part numbers for a given fault type.
    /// </summary>
